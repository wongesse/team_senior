...
public class HapticFeedback extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button haptic_button = findViewById(R.id.haptic);
        haptic_button.setOnClickListener(new View.OnClickListener() {
